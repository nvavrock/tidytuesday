...
author: "Nate Vavrock"
description: "UFC finish mix, reach advantage, and weight-class breakdowns from TidyTuesday week 27 (2026-07-07). Includes links to an interactive finish dashboard."
format:
  html:
    toc: true
    toc-depth: 2
...
Charts below embed static PNGs from `output/` (same files used for LinkedIn and slides). For filterable finish breakdowns — year, event, outcome, and division with linked donuts and a searchable fight table (2020–2026) — open the [interactive finish dashboard](output/_widget/finish_dashboard.html).
...
How have KO/TKO, submissions, and decisions shifted as a share of outcomes? The [interactive finish dashboard](output/_widget/finish_dashboard.html) lets you slice this pattern by year, event, and division.
