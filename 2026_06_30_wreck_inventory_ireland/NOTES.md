...
### `03_wreck_map.png`
**What:** Cartographic map — Tailte Éireann landmask + OSNI outline, Irish tricolor (Republic), St Patrick's saltire (Northern Ireland), Natural Earth 1:10m lakes, ~3,500 wreck points; Dublin (red) and Cork (blue) marked.  
