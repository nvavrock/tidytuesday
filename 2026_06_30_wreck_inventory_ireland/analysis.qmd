...
**Takeaway:** Mapped wrecks cluster along **Ireland's coasts and major shipping lanes** — especially the south and west. Only ~3,500 records (~20%) have coordinates, so the map shows known sites, not the full catalog.
